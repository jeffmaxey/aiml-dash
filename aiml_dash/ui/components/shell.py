        ...
        [
            dmc.Group(
                [
                    ...
                    dmc.Title(children=app_settings.APP_TITLE, order=3),
                ],
                gap="xs",
            ),
            dmc.Group(
...
def create_navigation():
    ...
    # Projects pages
    projects_items = [
        {"value": "projects", "label": "Projects", "icon": "carbon:folder"},
    ]
            ...
            dmc.AccordionItem(
                children=[
                    dmc.AccordionControl(
                        "Projects",
                        icon=DashIconify(icon="carbon:folder", width=20, height=20),
                    ),
                    dmc.AccordionPanel(dmc.Stack(create_nav_links(projects_items), gap="xs")),
                ],
                value="projects",
            ),
            dmc.AccordionItem(
