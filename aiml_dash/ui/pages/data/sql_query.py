...
from aiml_dash.managers.database import db_manager
            ...
            create_two_column_layout(
                ...
                create_control_card(
                    [
                        ...
                        create_action_button(
                            button_id="sql-new-connection-btn",
                            label="New Connection",
                            icon="carbon:add",
                            variant="light",
                        ),
                        create_action_button(
                            button_id="sql-test-connection-btn",
...
def execute_query(exec_clicks, preview_clicks, connection_name, query, dataset_name):
    ...
    if not ctx.triggered or not connection_name or not query:
        return create_empty_state(message="Select a connection and enter a query")
