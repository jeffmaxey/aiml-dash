...
def update_join_columns(dataset1, dataset2):
    ...
    df1 = app_manager.data_manager.get_dataset(dataset1)
    df2 = app_manager.data_manager.get_dataset(dataset2)
...
def combine_datasets(n_clicks, dataset1, dataset2, combine_type, join_on, result_name):
    ...
    try:
        ...
        app_manager.data_manager.set_active_dataset(result_name)
