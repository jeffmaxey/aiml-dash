...
def create_visualization(
    ...
    chart_type : Any
        Input value for ``chart_type``.
    x_var : Any
        Input value for ``x_var``.
    y_var : Any
        Input value for ``y_var``.
    color_var : Any
        Input value for ``color_var``.
    facet_var : Any
        Input value for ``facet_var``.
    title : Any
    ...
    try:
        ...
        if chart_type == "scatter":
            ...
            fig = px.imshow(
                corr_matrix, text_auto=True, title=title or "Correlation Heatmap"
            )
