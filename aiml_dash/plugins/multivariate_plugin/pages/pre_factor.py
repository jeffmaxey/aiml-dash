    ...
    try:
        ...
        summary = dmc.Stack(
            [
                ...
                dmc.Text(
                    f"P-value: {p_value:.4f}", c="green" if p_value < 0.05 else "red"
                ),
                dmc.Text(
        ...
        scree_fig.add_hline(
            y=1, line_dash="dash", line_color="red", annotation_text="Kaiser criterion"
        )
        ...
        kmo_data = [
            {"Variable": var, "KMO": f"{kmo_all[i]:.3f}"}
