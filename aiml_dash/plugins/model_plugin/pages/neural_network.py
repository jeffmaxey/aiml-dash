                    ...
                    dmc.TabsList(
                        [
                            ...
                            dmc.TabsTab(
                                ...
                                value="plot",
                                leftSection=DashIconify(
                                    icon="carbon:chart-line", width=16
                                ),
                            ),
                        ]
                    ),
...
def train_network(
    ...
    nn_type : Any
        Input value for ``nn_type``.
    hidden_layers : Any
        Input value for ``hidden_layers``.
    activation : Any
        Input value for ``activation``.
    lr : Any
        Input value for ``lr``.
    max_iter : Any
        Input value for ``max_iter``.
    seed : Any
        Value provided for this parameter."""
    ...
    try:
        ...
        results = {
            ...
            "loss_curve": model.loss_curve_.tolist()
...
def update_plot(plot_type, results):
    ...
    if plot_type == "loss":
        fig = go.Figure(
            go.Scatter(y=results["loss_curve"], mode="lines", name="Training Loss")
        )
        fig.update_layout(
