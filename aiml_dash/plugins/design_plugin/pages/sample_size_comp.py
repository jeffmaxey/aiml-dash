                                ...
                                [
                                    dmc.Stack(
                                        [
                                            ...
                                            dmc.Text(
                                                "Effect size range", size="sm", fw=500
                                            ),
                                            dmc.Group(
                                                [
                                                    dmc.NumberInput(
                            ...
                            dmc.Card(
                                [
                                    dmc.Stack(
                                        [
                                            dmc.Title(
                                                "Sample Size Comparison Chart", order=4
                                            ),
                                            dcc.Graph(
                                                id="ssc-chart",
                                                style={"height": "500px"},
...
def compare_sample_sizes(
    n_clicks, test_type, effect_min, effect_max, power_levels, alpha
):
    ...
    test_type : Any
        Input value for ``test_type``.
    effect_min : Any
        Input value for ``effect_min``.
    effect_max : Any
        Input value for ``effect_max``.
    power_levels : Any
        Input value for ``power_levels``.
    alpha : Any
